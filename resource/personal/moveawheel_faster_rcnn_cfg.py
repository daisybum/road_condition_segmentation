...
data_root = '/data/share/dataset/moveawheel/'
dataset_type = 'mmdet.datasets.MoveawheelDataset'
img_prefix = "personal_images"
prefix = 'COCO/per_'
postfix = ""
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=f'{prefix}train{postfix}.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=f'{prefix}valid{postfix}.json',
        data_prefix=dict(img=img_prefix),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=f'{prefix}test{postfix}.json',
        data_prefix=dict(img=img_prefix),
        test_mode=True,
...
#evaluator
val_evaluator = dict(
    type='mmdet.evaluation.CocomIoUMetric',
    ann_file=f'{data_root}{prefix}valid{postfix}.json',
    metric='bbox',
    format_only=False,
    classwise=True,
    backend_args=backend_args)
...
test_evaluator = dict(
    ann_file=f'{data_root}{prefix}test{postfix}.json',
    backend_args=None,
    classwise=False,
    format_only=False,
    metric='bbox',
